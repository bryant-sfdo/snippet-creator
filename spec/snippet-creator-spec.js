...
describe('SnippetCreator', () => {
  ...
  describe('when the snippet-creator:toggle event is triggered', () => {
    it('hides and shows the modal panel', () => {
      ...
      runs(() => {
        ...
        expect(snippetCreatorPanel.isVisible()).toBe(false);
      });
    });
    ...
    it('hides and shows the view', () => {
      ...
      runs(() => {
        ...
        let snippetCreatorElement = workspaceElement.querySelector('.snippet-creator');
        expect(snippetCreatorElement).toBeVisible();
        atom.commands.dispatch(workspaceElement, 'snippet-creator:toggle');
        expect(snippetCreatorElement).not.toBeVisible();
      });
    });
  });
});
